...
acc = Label(a, text="Already have an account?",
            font = ("Arial Bold", 8),
            bg = "#C0C9D1")
acc.place(x = 760, y = 535)
log = Button(a, text="Log in",
             font = ("Arial Bold", 8),
             bg = "white",
             command=signup)
log.place(x = 910, y = 535)
a.mainloop()