...
e1=Entry(a,width=20,font=("Arial Bold",20)).place(x=950,y=220)
l2=Label(a,text="Email :",font=("Arial Bold",16)).place(x=825,y=290)
e2=Entry(a,width=20,font=("Arial Bold",20)).place(x=950,y=290)
l3=Label(a,text="Password :",font=("Arial Bold",16)).place(x=825,y=350)
e3=Entry(a,width=20,font=("Arial Bold",20)).place(x=950,y=350)
chk=IntVar()
